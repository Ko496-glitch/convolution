...
// do more profiling
//fftw should habve a real fft.
// FFT OF REAL DATA 4.3 refelction pattern in depth



a + bi
[a] +  [bi// invoke the proprty

//switch fftw to real vectors vs  fftw complex
//normalize => against nlogn
//profile toeplitz and fft seperate in NTL
