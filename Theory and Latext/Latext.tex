...
// in ntl toep * matrx (from NTL vs fftw ) check for complex arithmetic 
// do more profiling // done
//fftw should habve a real fft. // done
// FFT OF REAL DATA 4.3 refelction pattern in depth // done 

a + bi
[a] +  [bi// invoke the proprty // done
//switch fftw to real vectors vs  fftw complex //done
//normalize => against nlogn // done
//profile toeplitz and fft seperate in NTL // done
//profile fftw floating precision with ntl output
mod p topelitz ,linbox
